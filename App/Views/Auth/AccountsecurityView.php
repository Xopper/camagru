<form id="form" class="form" method="POST">
	...
	<div class="form-control">
		...
		<input type="password" id="conf-Npass" name="conf-Npass" placeholder="confirm the new password" autocomplete="off" required>
		<small id="_conf-Npass">Error msg here</small>
	</div>

	<div class="form-control">
		<label for="Opassword">Confirm changes</label>
		<input type="password" id="Opassword" name="Opassword" placeholder="enter the old password" autocomplete="off" required>
